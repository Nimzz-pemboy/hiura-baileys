...
export const generateWAMessageContent = async (message, options) => {
    ...
    const buttons = (bm.buttons || []).map(btn =>
        proto.Message.ButtonsMessage.Button.create({
            ...
            nativeFlowInfo: btn.nativeFlowInfo
                ? proto.Message.ButtonsMessage.Button.NativeFlowInfo.create({
    ...
    m = {
        buttonsMessage: proto.Message.ButtonsMessage.create({
            ...
            buttons,
            headerType: bm.headerType || proto.Message.ButtonsMessage.HeaderType.LOCATION,
            contextInfo: bm.contextInfo || {},
