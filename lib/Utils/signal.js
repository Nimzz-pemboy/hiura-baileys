...
// Ported from @whiskeysockets/baileys 7.0.0-rc14 (Utils/signal.js).
// A <receipt type="retry"> can optionally carry a <keys> child with a fresh
// prekey bundle for the requesting device. When present, sendMessagesAgain()
// injects it directly via signalRepository.injectE2ESession(), skipping a
// full session teardown + renegotiation round trip. Returns null on any
// malformed/incomplete bundle so the caller can fall back to the old path.
