...
export class MessageRetryManager {
    constructor(logger, maxMsgRetryCount) {
        ...
        // Ported from baileys 7.0.0-rc14: remembers the Signal session base key we
        // saw for a given (address, messageId) retry, so a repeated retry with a
        // *different* base key can be recognised as a genuine session desync
        // (worth recreating the session) rather than just re-tried forever.
